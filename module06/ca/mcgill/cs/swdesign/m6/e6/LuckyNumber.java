package ca.mcgill.cs.swdesign.m6.e6;
...
/**
 * This version of the LuckyNumber adds a "Notify" button that notifies observers of the value in the model.
 * The value should only be propagated when the button is clicked.
 * @author Halil Murat
 *
 */
public class LuckyNumber extends Application
{
	...
	public void start(Stage pPrimaryStage) throws Exception
	{
		...
		Button btn = new Button();					// create new Button object
    	btn.setText("Notify");
